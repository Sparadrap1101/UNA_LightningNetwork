...
pub struct CreateChannelRequest {
    pub sat_per_vbyte: Option<String>, // <uint64> 
    pub node_pubkey: Option<String>, // <bytes> (base64 encoded)
    pub node_pubkey_string: Option<String>, // <string> 
    pub local_funding_amount: Option<String>, // <int64> 
    pub push_sat: Option<String>, // <int64> 
    pub target_conf: Option<String>, // <int32> 
    pub sat_per_byte: Option<String>, // <int64> 
    & more ... 
    
    (https://lightning.engineering/api-docs/api/lnd/lightning/open-channel/index.html)
}

impl From<CreateChannelParams> for CreateChannelRequest {
    fn from(params: CreateChannelParams) -> Self {
        CreateChannelRequest {
            sat_per_vbyte: params.sat_per_vbyte,
            node_pubkey: params.node_pubkey,
            node_pubkey_string: params.node_pubkey_string,
            local_funding_amount: params.local_funding_amount,
            push_sat: params.push_sat,
            target_conf: params.target_conf,
            sat_per_byte: params.sat_per_byte,
        }
    }
}*/
...
pub struct CreateChannelResponse {
    pub chan_pending: Object,
    pub chan_open: Object,
    pub psbt_fund: Object,
    pub pending_chan_id: String,
}

impl TryInto<CreateChannelResult> for CreateChannelResponse {
    type Error = Error;

    fn try_into(self) -> Result<CreateChannelResult, Self::Error> {
        let result = CreateChannelResult {
            chan_pending: self.chan_pending,
            chan_open: self.chan_open,
            psbt_fund: self.psbt_fund,
            pending_chan_id: self.pending_chan_id,
        };
