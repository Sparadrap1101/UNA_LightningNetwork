...
use crate::types::{
    ...
    PayInvoiceResult, // CreateChannelParams, CreateChannelResult
};
...
pub trait NodeMethods {
    ...
    // async fn create_channel(&self, invoice: CreateChannelParams) -> Result<CreateChannelResult, Error>;
}
...
/*
    async fn create_channel(&self, invoice: CreateChannelParams) -> Result<CreateChannelResult, Error> {
        self.node.create_channel(invoice).await
    }*/
}
